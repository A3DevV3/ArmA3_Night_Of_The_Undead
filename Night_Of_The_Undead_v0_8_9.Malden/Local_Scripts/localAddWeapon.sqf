...
then
{
	//If player has the weapon in question and has it active, then assume its because they want ammo
...
else //Otherwise assume its because they want the weapon
{
	_addWeaponOrAmmo = true;
};
...
then
{
	...
	else
	{
		...
		then							  //the player must have a weapon active if either weapon slot is filled
		{
			...
			//Patch for player PAP flag when equipping new weapon
